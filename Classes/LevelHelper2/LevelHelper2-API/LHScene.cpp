...
void LHScene::setGameWorldRect(Rect rect){
//    gameWorldRect = rect;
    
    Size designSize = getDesignResolutionSize();
    Point offset = getDesignOffset();
    
    gameWorldRect = Rect(rect.origin.x,
                         designSize.height - rect.origin.y,
                         rect.size.width ,
                         -rect.size.height);
